...
> This project is **not** part of the main Gradle multi-module build (`:core`, `:adapters:mc-forge-1-7-10`, `:adapters:mc-forge-1-7-10:demo`). It is built separately with Cargo.
...
- Rebuild trigger: `adapters/mc-forge-1-7-10/src/main/kotlin/org/dreamfinity/dsgl/mcForge1710/DsglScreenHost.kt`
